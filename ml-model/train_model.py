...
def generate_payment(user_id=None, base_time=None):
    ...
    is_fraud = int(
        ...
        or (is_large_amount and is_country_currency_mismatch and currency != "PLN")
        or (is_large_amount and country != ip_country and is_country_currency_mismatch)
        or (is_large_amount and country != ip_country and is_suspicious_device)
        or (is_large_amount and country != ip_country and currency != "PLN")
